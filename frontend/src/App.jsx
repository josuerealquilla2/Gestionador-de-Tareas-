...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-900">
      {/* Header */}
      <header className="bg-gradient-to-r from-violet-700 via-purple-700 to-blue-700 shadow-2xl">
        <div className="max-w-3xl mx-auto px-4 py-8 text-center">
          <h1 className="text-4xl font-bold text-white mb-1 tracking-tight">
            Gestionador de Tareas
          </h1>
          <p className="text-purple-200 text-sm">Organiza tu dia de forma simple</p>

          {tasks.length > 0 && (
            <div className="flex justify-center gap-6 mt-5">
              <div className="bg-white/10 backdrop-blur rounded-xl px-5 py-2.5 text-center">
                <p className="text-2xl font-bold text-amber-300">{pending}</p>
                <p className="text-purple-200 text-xs uppercase tracking-wide">Pendientes</p>
              </div>
              <div className="bg-white/10 backdrop-blur rounded-xl px-5 py-2.5 text-center">
                <p className="text-2xl font-bold text-emerald-300">{completed}</p>
                <p className="text-purple-200 text-xs uppercase tracking-wide">Completadas</p>
              </div>
              <div className="bg-white/10 backdrop-blur rounded-xl px-5 py-2.5 text-center">
